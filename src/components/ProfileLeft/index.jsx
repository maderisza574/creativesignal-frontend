  ...
  return (
    <div>
      <div className="card bg-light d-flex">
        <div className="row bg-light d-flex">
          <div className="left card bg-light">
            ...
            <div className="fs-5 mb-3 p-2" onClick={CreateBooking}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <div className="fs-5 mb-3 p-2" onClick={WishlistPage}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <div className="fs-5 mb-3 p-2" onClick={handleLogout}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
